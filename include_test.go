...
func (s *IncludeTestSuite) TestExecute() {
...
func (s *IncludeTestSuite) TestExecute_NoMergeVars() {
	scripts := make(fstest.MapFS)
...
func (s *IncludeTestSuite) TestExecute_NoMergeVars_WithBasePath() {
	scripts := make(fstest.MapFS)
...
func TestInclude(t *testing.T) {
	suite.Run(t, new(IncludeTestSuite))
}
